...
type Relation struct {
	...
	M *models.shopStoreProductRelation
...
//评价列表
func (d *Relation) GetUserCollectList() ([]models.shopStoreProductRelation, int, int) {
...
func (d *Relation) AddRelation() error {
	...
	model := &models.shopStoreProductRelation{
		Uid:       d.Uid,
...
func (d *Relation) DelRelation() error {
	...
	err := global.Db.
		...
		Delete(&models.shopStoreProductRelation{}).Error
	if err != nil {
...
func IsRelation(productId, uid int64) bool {
	...
	error = global.Db.Model(&models.shopStoreProductRelation{}).
		Where("uid = ?", uid).
